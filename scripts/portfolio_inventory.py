...
def route(name: str, upstreams: list[str], layer: str) -> tuple[str, str, str]:
    ...
    explicit_routes = {
        ...
        "rsomics-bam-divide": ("alignment-formats", "rsomics-bam"),
        "rsomics-bam-split-gene": ("alignment-formats", "rsomics-bam"),
        "rsomics-bam-split-pe": ("alignment-formats", "rsomics-bam"),
        ...
        "rsomics-fpkm-count": ("bulk-expression", "rsomics-count"),
        ...
        "rsomics-tpm": ("bulk-expression", "rsomics-count"),
        "rsomics-upgma": ("phylogenetics", "rsomics-phylo"),
        "rsomics-vcf-af-dist": ("genotype-analysis", "rsomics-plink"),
        "rsomics-vcf-call": ("variant-calling", "rsomics-call"),
        "rsomics-vcf-cnv": ("copy-number", "rsomics-cnv"),
        "rsomics-vcf-contrast": ("genotype-analysis", "rsomics-plink"),
        "rsomics-vcf-csq": ("functional-annotation", "rsomics-annotation"),
        "rsomics-vcf-freq-table": ("genotype-analysis", "rsomics-plink"),
        "rsomics-vcf-geno-r2": ("genotype-analysis", "rsomics-plink"),
        "rsomics-vcf-gtcheck": ("genotype-analysis", "rsomics-plink"),
        "rsomics-vcf-indv-stats": ("genotype-analysis", "rsomics-plink"),
        "rsomics-vcf-missing-stats": ("genotype-analysis", "rsomics-plink"),
        "rsomics-vcf-mpileup": ("variant-calling", "rsomics-call"),
        "rsomics-vcf-polysomy": ("copy-number", "rsomics-cnv"),
        "rsomics-vcf-roh": ("genotype-analysis", "rsomics-plink"),
        "rsomics-vcf-site-depth": ("genotype-analysis", "rsomics-plink"),
        "rsomics-vcf-smpl-stats": ("genotype-analysis", "rsomics-plink"),
        "rsomics-vcf-split-vep": ("functional-annotation", "rsomics-annotation"),
        "rsomics-vcf-trio-stats": ("genotype-analysis", "rsomics-plink"),
