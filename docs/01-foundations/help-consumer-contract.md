...
| `rsomics-bam` `dde097afee25` | thirteen SAM/BAM/CRAM inspection, pileup, depth, indexing, sorting, merging, collation, and mate-repair subcommands with unified global output | strict Clippy; debug and release suites; samtools 1.24 compatibility and representative performance gates; CI `31354120701`; published 0.10.0 and registry-reinstalled |
