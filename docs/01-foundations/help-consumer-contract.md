...
| `rsomics-bam` `0debc103993f` | twenty-four SAM/BAM/CRAM inspection, conversion, editing, pileup, statistics, indexing, sorting, merging, and collation subcommands with unified global output | strict Clippy; debug and release suites; samtools 1.24 compatibility and representative performance gates; CI `31407557237`; published 0.17.0 and registry-reinstalled |
