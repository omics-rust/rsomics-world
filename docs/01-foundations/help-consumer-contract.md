...
| `rsomics-bam` `5304f278bfaa` | twenty-five SAM/BAM/CRAM inspection, conversion, editing, pileup, statistics, indexing, sorting, merging, collation, and padded-reference subcommands with unified global output | strict Clippy; debug and release suites; samtools 1.24 compatibility and representative performance gates; CI `31414206433`; published 0.18.0 and registry-reinstalled |
