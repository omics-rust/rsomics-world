...
|---|---|---|---|
| `rsomics-common` | `416d3615e780` | narrowed the public runtime to demonstrated error, exit-code, output-mode, JSON-envelope, and runner contracts; removed speculative thread, RNG, logging, file, fixture, and tool abstractions; added fail-loud JSON emission fallback and, only after BED and VCF supplied two consumers, same-directory transactional output | 0.8.0 published; exact-head four-native-target CI `30620810041`; publish run `30620883859`; downloaded archive checksum `23e3b9e035a7a3c7988f68315e012dca5c0d79ba2a66683ffe6cabe13a023de7`; registry-package tests green |
