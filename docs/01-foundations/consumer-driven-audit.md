...
| `rsomics-pileup` | `25e2a3b242e6` | retains checked projection, retry-safe borrowed columns, per-source overlap and depth state, HTSlib-compatible BAQ, and bcftools-compatible column preparation while deleting its duplicate long-CIGAR decoder in favor of `rsomics-bamio` 0.6 | 0.6.0 published; exact-head four-native-target CI `30752575828`, including the samtools 1.24 differential; publish run `30752675956`; downloaded archive checksum `fc6fe12c37f33195379c5244d048beda85d0e2f5e32938b5a2fc0ba39afa1042`; ordinary and 30x/250x benchmark paths pass |
