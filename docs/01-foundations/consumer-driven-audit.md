...
| `rsomics-bamio` | `839df9b5bba3` | retains validated records and indexed SAM/BAM/CRAM input, and now owns checked ordinary and `CG:B,I` long-CIGAR decoding; pileup projection and methyl per-read calling supply independent consumer tests for the shared contract | 0.6.0 published; exact-head four-native-target CI `30752130426`; publish run `30752245303`; downloaded archive checksum `6bb58b15f550692d006c0c871fd30746e4b210e15a8eab2b3a2b8f28c2dd94d2` |
