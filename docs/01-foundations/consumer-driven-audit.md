...
|---|---|---|---|
| `rsomics-common` | `4c2032737780` | narrowed the public runtime to demonstrated error, exit-code, output-mode, JSON-envelope, runner, and structured-validation contracts; added one stdout-or-atomic-file writer after BED `aaee6d408329` and call `dd1bbe5a7cf7` supplied concrete consumers | 0.10.0 published; exact-head four-native-target CI `30713298892`; publish run `30713383317`; downloaded archive checksum `7a69695dae27897693c49ebedd96355dc9a5decb9f21956f0e8d9c5ce135a5ec` |
...
| `rsomics-bamio` | `94641eff97d7` | adds a validated reusable raw-record encoder without exposing product policy; BAM uses it for generic SAM/CRAM records and call uses it for its alignment stream; the indexed reader supports standard, alternative, and appended BAI/CSI/CRAI discovery | 0.3.0 published; exact-head four-native-target CI `30658611800`; publish run `30658840221`; downloaded archive checksum `6ac17eb096cd976f6000ff813430236df0b723eb360c926427d7928e46702a93` |
| `rsomics-pileup` | `a69743a8097f` | retains the checked projection and retry-safe borrowed-column contract, isolates mate-overlap state by input stream, applies an optional per-source depth ceiling, adds HTSlib-compatible standard/extended BAQ plus bcftools-compatible full and partial column preparation, and aligns its public raw-record type with bamio 0.3 | 0.3.0 published after call and BAM supplied concrete contracts; exact-head four-native-target CI `30659084469`; publish run `30659248849`; downloaded archive checksum `def4cc70d0cd250f8b9ebb1d1e0280c1a890cffb66504a832cb1819cff9f8581`; ordinary/deep performance and memory pass |
