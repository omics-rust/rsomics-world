...
| [rsomics-matrix-stats](https://github.com/omics-rust/rsomics-matrix-stats) | Fast row/column matrix statistics (median, var, sd, mean, min, max, quantile, mad, iqr, range, prod) — clean-room Rust port of R matrixStats, value-exact (≤1e-12, type-7 quantile / 1.4826 mad), 2.1–17.8× single-thread |
