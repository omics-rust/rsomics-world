...
| [rsomics-prot-param](https://github.com/omics-rust/rsomics-prot-param) | Protein physico-chemical properties (instability/GRAVY/aromaticity/MW/composition) — value-exact to Biopython Bio.SeqUtils.ProtParam (≤2e-15), 13.5× single-thread |
