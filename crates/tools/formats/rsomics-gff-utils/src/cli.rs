...
pub static HELP: HelpSpec = HelpSpec {
    name: env!("CARGO_PKG_NAME"),
    version: env!("CARGO_PKG_VERSION"),
    tagline: "GFF/GTF utility toolkit — count, filter, extract, sort, convert, and stats operations.",
    origin: Some(Origin {
        upstream: "gffutils / agat",
    ...
    examples: &[
        Example {
            description: "Count gene features",
            command: "rsomics-gff-utils gene-count annotation.gff3",
        },
        Example {
            description: "Extract all gene features",
            command: "rsomics-gff-utils genes annotation.gff3 -o genes.gff",
        },
        Example {
            description: "Convert GFF to BED",
            command: "rsomics-gff-utils to-bed annotation.gff3 -o annotation.bed",
        },
    ],
