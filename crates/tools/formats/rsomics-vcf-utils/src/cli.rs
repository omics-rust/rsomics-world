...
pub static HELP: HelpSpec = HelpSpec {
    name: env!("CARGO_PKG_NAME"),
    version: env!("CARGO_PKG_VERSION"),
    tagline: "VCF utility toolkit — view, filter, count, stats, and convert operations.",
    origin: Some(Origin {
        upstream: "bcftools / vcftools",
        upstream_license: "MIT/GPL",
    ...
    examples: &[
        Example {
            ...
            command: "rsomics-vcf-utils count variants.vcf.gz",
        },
        Example {
            description: "Filter to SNPs only",
            command: "rsomics-vcf-utils snps variants.vcf -o snps.vcf",
        },
        Example {
            description: "Transition/transversion ratio",
            command: "rsomics-vcf-utils ts-tv variants.vcf",
        },
    ],
