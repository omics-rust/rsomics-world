...
use rsomics_fastq_downsample::fastq_downsample;
...
impl Cli {
    pub fn execute(self) -> Result<()> {
        ...
        let _ = fastq_downsample(&self.input, &mut out)?;
        Ok(())
    }
}
pub static HELP: HelpSpec = HelpSpec {
    ...
    tagline: "Downsample FASTQ to target coverage",
    origin: Some(Origin {
        upstream: "custom",
    ...
    examples: &[Example {
        description: "Run",
        command: "rsomics-fastq-downsample input",
    }],
