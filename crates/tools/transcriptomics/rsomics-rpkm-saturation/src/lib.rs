...
//!    c. Per gene: raw_count = # reads overlapping any exon of the gene;
//!       gene_length_kb = total exon bases / 1000;
//!       total_mapped_millions = sample_size / 1_000_000;
//!       RPKM = raw_count / (gene_length_kb * total_mapped_millions).
