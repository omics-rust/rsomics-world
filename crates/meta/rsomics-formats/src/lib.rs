...
pub mod fastq {
    ...
    pub use rsomics_fastq_downsample as downsample;
...
pub mod vcf {
    ...
    pub use rsomics_vcf_to_bed as to_bed;
...
pub mod bam {
    ...
    pub use rsomics_bam_compare as compare;
    ...
    pub use rsomics_bam_fingerprint as fingerprint;
    ...
    pub use rsomics_bam_junctions as junctions;
...
#[cfg(feature = "bed")]
pub mod bed {
    pub use rsomics_bed_annotate as annotate;
    ...
    pub use rsomics_bed_multicov as multicov;
